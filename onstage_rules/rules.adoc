= RoboCupJunior OnStage Rules 2025 - DRAFT
{docdate}
:toc: left
:sectanchors:
:sectlinks:
...
[discrete]
== General rules
{++Refer to the general RoboCupJunior rules (https://junior.robocup.org/robocupjunior-general-rules/) for additional restrictions and requirements.++}
