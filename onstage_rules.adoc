= RoboCupJunior OnStage Rules 2023
{docdate}
:toc: left
:sectanchors:
:sectlinks:
...
Special rules for [blue-background]#on-site competitions are highlighted in blue# while
[green-background]#virtual elements are highlighted in green#.
Sections with no highlighting apply to every kind of competition.

Major changes from the 2022 OnStage rules are written in [red]#red#.
